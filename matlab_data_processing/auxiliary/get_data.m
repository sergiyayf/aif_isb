%function to store all the data from the images
 ...
 function Colony = get_data(File, radius, radius_count, center, colEdge, load_streaks, segment_color, count_red, count_blue, count_mixed, count_total, red_pixels, blue_pixels, total_pixels ) 
 ...
 Colony.red_pixels = red_pixels;
 Colony.blue_pixels = blue_pixels;
 Colony.total_pixels = total_pixels; 
 end

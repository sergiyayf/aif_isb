...
%structure mat file
function Multifile_analysis_function(input_filename, input_directory, Colony_output_directory, Colony_output_name, Image_output_directory)
...
%convert to binary and do manipulations to count along the edge then
edgeImage = edge(BW);
...
Y_edge = fix((Y_edge-center(2))*0.945+center(2));
X_edge = fix((X_edge-center(1))*0.945+center(1));
...
Colony(i) = get_data(file, RR, RR, center, Streaks_matrix, segment_color, count_red, count_blue, count_mixed, count_total);
